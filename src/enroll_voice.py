...
def extract_and_save_embedding():
    ...
    # Read audio directly using soundfile to bypass torchaudio torchcodec issue
    ...
    print(f"\nMaster voice embedding saved successfully to `{OUTPUT_NPY}`! Vector shape: {master_embedding.shape}")
